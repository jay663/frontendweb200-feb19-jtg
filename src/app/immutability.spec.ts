describe('immutability with arrays', () => {
  it('add an item to an array', () => {
    const numbers = [1, 2, 3, 4, 5];

    const newNumbers = [...numbers, 6];
    // spread operator when inside an array
    // [0, ...numbers, 7]
    // returns [0, 1, 2, 3, 4, 5] creates a new array and can add an element at front or back
  ...
  describe('immutable with objects', () => {
    it('adding a property to an object', () => {
      const movie: any = { title: 'Thor Ragnorak', director: 'Taika Waititit' };
