describe('declaring variables ect with Typescript', () => {
  ...
  describe('tuples', () => {
    ...
    it('formatting a name with a tuple', () => {
      function formatName(first: string, last: string): [string, number] { // returns an anonymous tuple type
        const fullName = `${last}, ${first}`;
...
describe('object literal', () => {
  it('has them', () => {
    ...
    // duck typing at play here henry looks like a duck or a person in this case
    getPersonInfo(henry);
  });
